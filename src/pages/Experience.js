    ...
    return(
        <div name="experience" className="w-full md:h-screen bg-[#282C2F] text-[#f1f0ec]">
            <div className="max-w-screen-lg mx-auto p-4 flex flex-col justify-center w-full h-full">
                <div>
                    <p className="text-4xl font-bold border-b-4 border-[#00FFFF] p-2 inline">Experience</p>
                    <p className="py-6"><span className="text-[#00FFFF]">//</span> Here are some of the technologies I've worked with</p>
                </div>
