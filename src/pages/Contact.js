...
function Contact(){
    return(
        <div name='contact' className="w-full h-screen bg-[#659DBD]">
            <div className="flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full">
                ...
                <div className="flex justify-center items-center">
                    <form action="https://getform.io/f/dfe07823-2256-4145-bcad-602f78658d39" method="POST" className="flex flex-col w-full md:w-1/2">
                        ...
                        <textarea name="message" rows="6" className="p-2 bg-transparent border-2 rounded-md focus:outline-none">

                        </textarea>

                        <button className="bg-gray-300 px-6 py-3 my-8 mx-auto flex items-center rounded-md hover:scale-110 duration-300">
                            Submit
                        </button>
                    </form>
                </div>
